...
`;
export function buildSisyphusLiteOverlay() {
...
export function buildHephaestusLiteOverlay() {
    return `${COMMON_LITE_POLICY}
...
export function buildPrometheusLiteOverlay() {
    return `${COMMON_LITE_POLICY}
...
export function buildAtlasLiteOverlay() {
    return `${COMMON_LITE_POLICY}
